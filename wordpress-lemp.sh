...
echo "================================================================"
echo "============= Welcome to the Wordpress CMS installer ==========="
echo "================================================================"
...
echo "================================================================"
echo "======== A robot is now installing Wordpress CMS for you ======="
echo "========================== ETC = 120s =========================="
echo "================================================================"
...
if $varnaked;
  then sudo wget --no-check-certificate 'https://raw.githubusercontent.com/cmswizard/wordpress-lemp/main/config.txt' -O /etc/nginx/sites-enabled/"$var01" && sudo sed -i "s/domain/$var01/g" /etc/nginx/sites-enabled/"$var01";
elif $varwww;
  then sudo wget --no-check-certificate 'https://raw.githubusercontent.com/cmswizard/wordpress-lemp/main/config-www.txt' -O /etc/nginx/sites-enabled/"$var01" && sudo sed -i "s/domain/$var011/g" /etc/nginx/sites-enabled/"$var01";
else 
  sudo wget --no-check-certificate 'https://raw.githubusercontent.com/cmswizard/wordpress-lemp/main/config-non-www.txt' -O /etc/nginx/sites-enabled/"$var01" && sudo sed -i "s/domain/$var01/g" /etc/nginx/sites-enabled/"$var01";
fi
...
echo "=======================-== DONE! ============================"
echo "=========== Wordpress CMS is installed sucessfully =========="
echo "=================== =================== ====================="
